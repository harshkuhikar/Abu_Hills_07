...
import { Crown, Star, Award, MapPin, Phone, Mail, Calendar, Download, ChevronRight, Sparkles, Home as HomeIcon, Car, Wifi, Shield, Waves, Dumbbell, TreePine, Users, Coffee, Gamepad2 } from 'lucide-react';
...
const Home: React.FC = () => {
  const handleDownloadBrochure = () => {
    ...
    // Footer
    const footerGradient = ctx.createLinearGradient(0, canvas.height - 100, canvas.width, canvas.height - 100);
    ...
    ctx.textAlign = 'center';
    ctx.fillText('Schedule Your Visit Today!', canvas.width / 2, canvas.height - 40);
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden hero-modern">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto animate-modern-float">
          ...
          <p className="text-xl mb-8 text-neutral-200 max-w-3xl mx-auto leading-relaxed">
            Experience the pinnacle of luxury living in our meticulously designed weekend homes, 
            where every detail reflects sophistication and comfort in the peaceful Abu Hills community.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Every aspect of Abu Hills has been crafted to provide an unparalleled living experience
            </p>
          </div>
          ...
          <div className="grid-modern">
            <div className="card-aesthetic group p-8 interactive-modern animate-minimalistic-scale">
              ...
              <h3 className="text-2xl font-bold text-neutral-800 mb-4">Spacious Interiors</h3>
              <p className="text-neutral-600 leading-relaxed">
                Thoughtfully designed living spaces with premium finishes, modern amenities, and panoramic views of the surrounding hills.
              </p>
            </div>
            
            <div className="card-aesthetic group p-8 interactive-modern animate-minimalistic-scale">
              <Shield className="w-12 h-12 text-emerald-600 mb-6 group-hover:scale-110 transition-transform" />
              <h3 className="text-2xl font-bold text-neutral-800 mb-4">Premium Security</h3>
              <p className="text-neutral-600 leading-relaxed">
                24/7 professional security services, gated community access, and advanced surveillance systems for complete peace of mind.
              </p>
            </div>
            
            <div className="card-aesthetic group p-8 interactive-modern animate-minimalistic-scale">
              <TreePine className="w-12 h-12 text-emerald-600 mb-6 group-hover:scale-110 transition-transform" />
              <h3 className="text-2xl font-bold text-neutral-800 mb-4">Natural Beauty</h3>
              <p className="text-neutral-600 leading-relaxed">
                Surrounded by lush landscapes and meticulously maintained gardens, offering a serene escape from city life.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {amenities.map((amenity, index) => (
              <div key={index} className="card-modern group p-6 text-center interactive-modern animate-minimalistic-pulse">
                <amenity.icon className="w-10 h-10 text-emerald-600 mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="font-semibold text-neutral-800 mb-2">{amenity.name}</h3>
                <span className="text-sm text-emerald-600 font-medium">{amenity.category}</span>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-emerald-200 max-w-3xl mx-auto">
              Ready to experience luxury living? Get in touch with our expert team today.
            </p>
          </div>
          ...
          <div className="grid-modern">
            <div className="card-aesthetic p-8 bg-gradient-to-br from-emerald-700 to-emerald-800 rounded-2xl text-center animate-minimalistic-glow">
              ...
              <a href="tel:+919327586040" className="text-emerald-300 hover:text-emerald-200 text-lg font-semibold transition-colors">
                +91-93275-860-40
              </a>
            </div>
            ...
            <div className="card-aesthetic p-8 bg-gradient-to-br from-emerald-700 to-emerald-800 rounded-2xl text-center animate-minimalistic-glow">
              ...
              <a href="mailto:info@abuhills.com" className="text-emerald-300 hover:text-emerald-200 text-lg font-semibold transition-colors">
                info@abuhills.com
              </a>
            </div>
